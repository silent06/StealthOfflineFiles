...
extern VOID WriteINI();
extern VOID ReadINI();
//extern static PVOID(__cdecl *mmGetPhysicalAddress)(PVOID ptr) = (PVOID(*)(PVOID))0x80080048;
//extern static DWORD(__cdecl *xeKeysExecute)(PVOID pvPhyBuffer, DWORD len, PVOID arg1, PVOID arg2, PVOID arg3, PVOID arg4) = (DWORD(*)(PVOID, DWORD, PVOID, PVOID, PVOID, PVOID))0x80109FF8;
